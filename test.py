...
# with open('Forms/Text/Công dân/Có con nhỏ/thay_doi_thong_tin_cu_tru_nuoc_ngoai.txt', 'r', encoding='utf-8') as f:
#     doc = f.read()
...
# prompt_parts = CONST.form_tagging_prompt.format(main_tag_names= CONST.main_tag_names, relationship_tag_names = CONST.relationship_tag_names, Form = blanked_text)
