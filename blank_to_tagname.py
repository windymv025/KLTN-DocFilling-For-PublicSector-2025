...
# prompt_parts = [
#   f"""
#   Give you list of tag names. Your task is to choose a right tag name to replace the (Blankx) gived by Question in the Abstract. Your response only have format [Blankx:#tagname]. If you don't have answer, reply with [Blankx:#Empty].
